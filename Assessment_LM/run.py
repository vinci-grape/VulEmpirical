...
def convert_examples_to_features(js, tokenizer, args):
    ...
    return InputFeatures(source_ids, number_to_rating(js['assessment_label']), js['index'])
...
def main():
    ...
    parser.add_argument("--model_type", default="roberta", type=str, choices=['roberta', 'plbart', 'codet5'])
